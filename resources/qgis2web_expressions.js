...
function exp__2rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Численность')  > 100000);
    } else {
        return (feature.get('Численность')  > 100000);
    }
}
...
function exp__2rule1_eval_expression(context) {
    // "Численность" >= 10000 AND "Численность" < 100000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Численность')  >= 10000) && (feature.get('Численность')  < 100000));
    } else {
        return ((feature.get('Численность')  >= 10000) && (feature.get('Численность')  < 100000));
    }
}
...
function exp__2rule2_eval_expression(context) {
    // "Численность" >= 1000 AND "Численность" < 10000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Численность')  >= 1000) && (feature.get('Численность')  < 10000));
    } else {
        return ((feature.get('Численность')  >= 1000) && (feature.get('Численность')  < 10000));
    }
}
...
function exp__2rule3_eval_expression(context) {
    // "Численность" > 0 AND "Численность" < 1000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Численность')  > 0) && (feature.get('Численность')  < 1000));
    } else {
        return ((feature.get('Численность')  > 0) && (feature.get('Численность')  < 1000));
    }
}
...
function exp__2rule4_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Численность')  === null);
    } else {
        return (feature.get('Численность')  === null);
    }
}